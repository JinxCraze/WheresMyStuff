 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Eric Sheen");
		  toPrint += p1.toString("esheen3");
		  ...
		  Person3 p3 = new Person3("Kelsey Murdock");
		  toPrint += p3.toString("kmurdock7");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Kirtan Patel");
          toPrint += p4.toString("kpatel349");
